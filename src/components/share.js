  ...
  return (
    <section>
      ...
      <Flex sx={{ justifyContent: "center", flexWrap: "wrap" }}>
        <Box
          as="figure"
          sx={{ m: 0, p: 8, width: ["100%", null, null, "50%", null, "25%"] }}
        >
          <Img
            alt="a"
          ...
          >
            (Sized for the Instagram Square)
          </figcaption>
        </Box>
        <Box
          as="figure"
        ...
        >
          ...
          >
            (Sized for the Facebook Timeline)
          </figcaption>
        </Box>
        <Box
          as="figure"
        ...
        >
          ...
          >
            (Sized for the Twitter Timeline)
          </figcaption>
        </Box>
      </Flex>
    </section>
